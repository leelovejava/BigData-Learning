...
object StructuredSessionizationFlatmap {
...
//        .cast("timestamp"), fruit("fruit"))
    ...
    val sessionUpdates = events
      ...
      .flatMapGroupsWithState[SessionInfo, SessionUpdate](OutputMode.Update(),GroupStateTimeout.ProcessingTimeTimeout) {
...
//            返回的是一个iterstor
            Seq(SessionUpdate(sessionId, state.get.durationMs, state.get.numEvents, expired = false)).iterator
          }
      }
