...
public class CuratorTest {
    ...
    public static Logger log = LoggerFactory.getLogger(CuratorTest.class);
    ...
    public void distributedLock() {
        ...
        ///client = CuratorFrameworkFactory.newClient("10.23.22.237:2181", retryPolicy);
        client.start();
    ...
    private void doWork() throws Exception {
        ...
        try {
            ...
            log.info("Thread ID:" + Thread.currentThread().getId() + " acquire the lock");

            Thread.sleep(1000);

            log.info("Thread ID:" + Thread.currentThread().getId() + " release the lock");
        } catch (Exception e) {
